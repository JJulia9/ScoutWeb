    ...
    <h2 className="text-4xl text-center mb-10 font-heading text-primary">Contact Us</h2> 
        <div class="container flex flex-col mx-auto max-w-screen-xl bg-primary rounded-xl">
            <div class="w-full draggable p-5">
                <div class="container flex flex-col items-center gap-16 mx-auto m-10">
                    <div class="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <p class="text-2xl font-extrabold text-primary font-heading">Email</p>
                        <p class="text-base leading-7 text-text font-paragraph">Contact us at</p>
                        <Link to="mailto: obanshirescouts@gmail.com" class="text-lg font-bold text-nav font-paragraph">obanshirescouts@gmail.com</Link>
                        </div>
                        <div class="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none">
                        ...
                        <p class="text-2xl font-extrabold text-primary font-heading">Phone</p>
                        <p class="text-base leading-7 text-text font-paragraph">Reach out to us by phone</p>
                        <Link to=" tel: +44-74-4444-4444" class="text-lg font-bold text-nav font-paragraph" >+44-74-4444-4444</Link>
                        </div>
                        <div class="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none">
                        ...
                        <p class="text-2xl font-extrabold  text-primary font-heading">Location</p>
                        <p class="text-base leading-7 text-text font-paragraph">Find us at</p>
                        <Link to="https://maps.app.goo.gl/2n74uyFKpwWo4S4S6" class="text-lg font-bold text-nav font-paragraph" >4 Victoria Circus, Glasgow G12 9LD</Link>                        </div>
                    </div>
                </div>
            </div>
        </div>
