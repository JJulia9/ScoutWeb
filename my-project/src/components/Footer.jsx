    ...
    return (
        ...
        <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <Link to="/">
                <img src="/logoScouts.svg" alt="logo" className="h-12" />
              </Link>
      
              <p className=" font-paragraph mt-4 max-w-xs text-gray-500">
              Adventure Awaits, Together We Explore!
              </p>
            ...
            <div>
                <p className=" font-paragraph font-medium  text-secondary font-semibold">Account</p>
              ...
              <div>
                <p className="font-medium font-paragraph text-secondary font-semibold">Pages</p>
              ...
              <div>
                <p className="font-medium text-secondary font-semibold font-paragraph ">Info</p>
          ...
          <p className="text-xs text-gray-500">&copy; 2001. Obanshire Cub Scouts. All rights reserved.</p>
        </div>
      </footer>
    );
}
