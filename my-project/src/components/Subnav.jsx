...
<div className='flex text-xs sm:text-base'>
            ...
            <button onClick={() => onNavigate('section1')}  className="text-nav font-medium font-paragraph border-b-2 rounded-r-xl border-transparent focus:border-accent flex px-5 items-center leading-5 hover:rounded-xl hover:bg-red-100 focus:bg-red-100 focus:outline-none  focus: rounded-xl transition duration-150 ease-in-out">
                Cubs
            </button>

            <button onClick={() => onNavigate('section2')}  className="text-nav font-medium font-paragraph border-b-2 rounded-r-xl border-transparent focus:border-accent flex px-5 items-center py-6  leading-5 hover:rounded-xl hover:bg-red-100 focus:bg-red-100 focus:outline-none  focus: rounded-xl transition duration-150 ease-in-out">
                Helpers
            </button>
